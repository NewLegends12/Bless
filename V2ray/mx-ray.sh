...
cd /usr/bin
wget -O addws "https://${mdxvpn}/addws.sh"
wget -O addvless "https://${mdxvpn}/addvless.sh"
wget -O addtr "https://${mdxvpn}/addtr.sh"
wget -O addwstls "https://${mdxvpn}/addwstls.sh"
wget -O delws "https://${mdxvpn}/delws.sh"
wget -O delvless "https://${mdxvpn}/delvless.sh"
wget -O delnon "https://${mdxvpn}/delnon.sh"
wget -O renewnon "https://${mdxvpn}/renewnon.sh"
wget -O deltr "https://${mdxvpn}/deltr.sh"
