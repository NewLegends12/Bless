...
############MDX Network#############
clear
mdxvpn="raw.githubusercontent.com/Exe303/Bless/main/Xray"
red='\e[1;31m'
green='\e[0;32m'
yell='\e[1;33m'
NC='\e[0m'
...
wget -q -O /usr/bin/bbr "https://raw.githubusercontent.com/Exe303/Bless/main/Xray/bbr.sh"
chmod +x /usr/bin/bbr
bbr >/dev/null 2>&1
...
sleep 1
cd /usr/bin
wget -O menuss "https://${mdxvpn}/menuss.sh"
wget -O menutrojan "https://${mdxvpn}/menutrojan.sh"
wget -O menuvless "https://${mdxvpn}/menuvless.sh"
wget -O menuvmess "https://${mdxvpn}/menuvmess.sh"
wget -O crtxray "https://${mdxvpn}/crt.sh"
